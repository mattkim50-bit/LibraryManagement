...
public class LibraryMain {
     ...
     * <p>수정과 삭제의 효율화를 위해 같은 기능으로 개발(26.05.20; 김민혁)</p>
     * @see <a href="https://github.com/mattkim50-bit/LibraryManagement/issues/1">Issue #1: 한 책 삭제 시 DB에서 해당 책이 삭제 안됨</a>
